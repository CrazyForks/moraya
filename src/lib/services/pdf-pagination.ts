 ...
 *
 * Kept in its own module (no html2canvas / jsPDF / Tauri imports) so it can be
 * unit-tested in isolation — importing export-service.ts pulls heavy browser
 * deps that don't load under the test runner.
 */
